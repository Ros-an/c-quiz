...
import { Questions } from "../../context-api/GlobalContext";
...
function QuizQuestion({ questions }: { questions: Questions[] }) {
  const {
    index,
    nextQuestion,
    resetIndex,
      ...
      <div className="quiz-question">
        <div className="quiz-question__heading">
          ...
          <div className="sub-section">
            ...
            <Text fontSize="2xl">Score {`${correct}/${questions.length}`}</Text>
          </div>
        </div>
